...
(function (win, doc, undefined) {
    ...
    pl.extend(ke.import, {
        ...
        add: function (src, callback) {
            ...
            //console.log(src.substr(0, 5), ke.getConst('ROOT_PREFIX'));
            ...
            if (root) {
                pl.ajax({
                    ...
                    error: function (err_code, err_text) {
                        if (ke.IS_EDGE && err_text.indexOf('function') > -1) {
                            if (src.substr(src.length - 4) === '.css') {
                                pl('<style>', {
                                    type: 'text/css'
    ...
    pl.extend(ke.data, {
        ...
        kernel: {
            ...
            info: {
                ...
                ver: (navigator.appVersion.match('Chrome/([0-9\.]+)') || navigator.userAgent.match('Firefox/([0-9\.]+)'))[1],
    ...
    pl.extend(ke.idb, {
        ...
        open: function (db_name, table, indexes, callback) {
            var request = win.indexedDB.open(db_name, 25);
